...
# ==========================================
# 6. DESIGN SYSTEM: WORKSTATION RESPONSIVA E ÁUDIO
# ==========================================
...
/* REVELA E ESTILIZA O BOTÃO DE ABRIR/FECHAR SIDEBAR */
.sidebar-button, button[aria-label*="sidebar" i], button[title*="sidebar" i] {
    position: fixed !important; top: 15px !important; left: 15px !important; background-color: #0E0E0E !important;
    border: 1px solid #D4AF37 !important; border-radius: 50% !important
